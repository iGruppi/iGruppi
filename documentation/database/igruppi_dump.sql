...
--
-- Host: localhost
-- Generation Time: Sep 11, 2013 at 12:05 AM
...
CREATE TABLE `categorie` (
  ...
  PRIMARY KEY (`idcat`),
  KEY `fk_categorie_categorie1_idx` (`idpadre`)
...
CREATE TABLE `groups_produttori` (
...
CREATE TABLE `ordini_user_prodotti` (
