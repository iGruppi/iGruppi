...
class Model_Db_Listini extends MyFw_DB_Base {
    ...
    {
        $sql = "INSERT INTO listini_prodotti (idlistino, idprodotto, costo_listino, note_listino)
                SELECT :idlistino, idprodotto, costo, note FROM prodotti WHERE idproduttore= :idproduttore AND attivo='S' AND production='S'";
        $sth = $this->db->prepare($sql);
    ...
    {
        $sql = "INSERT INTO listini_prodotti (idlistino, idprodotto, costo_listino, note_listino)
                SELECT :idlistino, idprodotto, costo, note FROM prodotti WHERE idprodotto= :idprodotto";
        $sth = $this->db->prepare($sql);
