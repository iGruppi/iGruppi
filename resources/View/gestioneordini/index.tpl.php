...
<?php if(Zend_Registry::get("permsProduttori")->canOpenNewOrdine()): ?>
...
<?php endif; ?>        
    ...
    <?php $stati = Model_Ordini_State_OrderFactory::getOrderStatesArray();
            foreach($stati AS $stato): ?>
                <a <?php if($this->filter == $stato){ echo 'class="selected"'; } ?> href="/gestione-ordini/index/filter/<?php echo $stato; ?>"><?php echo $stato; ?>
         <?php if(isset($this->counterOrdiniStati[$stato]) && $this->counterOrdiniStati[$stato] > 0): ?>
                <span class="badge"><?php echo $this->counterOrdiniStati[$stato]; ?></span>
         <?php endif; ?>
                </a>
    <?php   endforeach; ?>
              </div>
