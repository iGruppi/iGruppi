    ...
    <fieldset id="fs_validita" class="border_top">
        ...
        <select name="validita" id="validita">
            <option value="N" <?php if(!$this->listino->getValidita()->isSetValidita()){ echo 'selected=""'; } ?>>Sempre</option>
            <option value="S" <?php if($this->listino->getValidita()->isSetValidita()){ echo 'selected=""'; } ?>>Imposta periodo</option>
        </select>
        <br />
        <div id="d_validita" style="display: <?php echo ($this->listino->getValidita()->isSetValidita()) ? "block" : "none"; ?>;">
