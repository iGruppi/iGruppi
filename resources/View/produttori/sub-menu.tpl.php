<div class="btn-group btn-group-myig">
    <?php if(Zend_Registry::get("permsProduttori")->canManageProduttore($produttore->idproduttore)): ?>
          ...
          <ul class="dropdown-menu" role="menu">
              <li><a href="/produttori/view/idproduttore/<?php echo $produttore->idproduttore;?>">Scheda produttore</a></li>
            <li><a href="/produttori/edit/idproduttore/<?php echo $produttore->idproduttore;?>">Modifica Dati produttore</a></li>
