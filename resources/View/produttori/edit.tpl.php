...
<?php endif; ?>
    ...
    <form id="prodform" action="<?php echo $this->form->getAction(); ?>" method="post" class="f1n150">
        ...
        <ul class="nav nav-tabs" id="myTab">
            ...
            <li><a href="#campi_descrittivi" data-toggle="tab">Presentazione</a></li>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane" id="campi_descrittivi">
                <?php include $this->template('produttori/form.campi_descrittivi.tpl.php'); ?>
            </div>
